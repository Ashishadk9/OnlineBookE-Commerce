   ...
   <div class="pending-list">
    <c:forEach var="u" items="${pendingList}">
      <div class="pending-item">
        ...
        <div>
            <a href="${pageContext.request.contextPath}webapp/admin/approveUsers? action=approve&id=${u.id}"
               class="approve-btn"> Approve</a>
            <a href="${pageContext.request.contextPath}webapp/admin/approveUsers? action=reject&id=${u.id}"
